...
export class MmdPlayerControl {
    public readonly onPlaybackRateChangedObservable: Observable<number>;
    ...
    public setPlaybackRate(rate: number, notify: boolean = true): void {
        this._mmdRuntime.timeScale = rate;
        this._speedSlider.value = rate.toString();
        this._speedLabel.innerText = rate.toFixed(2) + "x";
        if (notify) this.onPlaybackRateChangedObservable.notifyObservers(rate);
    }
                ...
                playerInnerContainer.appendChild(playerLowerContainer);
                {
                    ...
                    playerLowerContainer.appendChild(playerLowerRightContainer);
                    {
                        ...
                        speedSlider.oninput = (): void => {
                            ...
                            this.onPlaybackRateChangedObservable.notifyObservers(mmdRuntime.timeScale);
